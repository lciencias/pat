...
$content_mail.="<br>Backup de la Base de datos<br>";
$error = false;
$tablas = 0;
$total_tablas = 0;
$total_rows = 0;
...
if( !@function_exists( 'gzopen' ) ) {
    ...
    $hay_Zlib = true;
    $content.="<br>- El nombre del Backup de la Base de Datos se llamara: '$filename_href'<br>";
    $content_mail.="<br>- El nombre del Backup de la Base de Datos se llamara: ".$filename_href."<br><br><br>Tablas:<br>" ;
}
if( !$error ) {
...
if( !$error ) {
    ...
    if( !$result ) {
        ...
        {                   
            ...
            $content_mail.= "<br><br>Se ha creado el respaldo del dia:  ".$fechahd."<br><br>";            
            $header = 'MIME-Version: 1.0' . "\r\n";
            $header.= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
            $header.= "from:lciencias@gmail.com\r\n";            
            mail("lciencias@gmail.com","Respaldo PAT",$content_mail,$header);            
        }
	}
