...
<!-- <div class="modal fade" id="myModalActualizaTmp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" style="width:950px;height: 500px;">
        	<div class="modal-content" style="width:950px;height: 500px;">
                <div class="modal-body"  style="width:950px;height: 500px;>
					<div id="content">
								...
								<table class='table table-condensed'>
									...
									<tr class='altotitulo'>
										...
										<td class='tdleft alinea' colspan='2'>
											<input type='radio' name='ponderacionc' id='ponderacionc5' value='5'>5&nbsp;&nbsp;
						                    <input type='radio' name='ponderacionc' id='ponderacionc4' value='4'>4&nbsp;&nbsp;
						                    <input type='radio' name='ponderacionc' id='ponderacionc3' value='3'>3&nbsp;&nbsp;
						                    <input type='radio' name='ponderacionc' id='ponderacionc2' value='2'>2&nbsp;&nbsp;
						                    <input type='radio' name='ponderacionc' id='ponderacionc1' value='1'>1
										</td>
									</tr>
									<tr class='altotitulo'>
