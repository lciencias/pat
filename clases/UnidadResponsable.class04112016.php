...
class UnidadResponsable  extends Comunes implements InterfazCatalogos{
    ...
    function listado(){
        ...
        if($no_registros > 0)
        {
            ...
            $sql="SELECT DISTINCT(a.".$this->campo."),a.nombre,a.active,a.orden FROM ".$this->tabla."
                ...
                $buffer.="
                    ...
                    <thead>
                        <tr class='alturaTableHeader'>
                            ...
                            <td width='40%' class='tdcenter cabecerasTable'>".POLITICAPUBLICA."</td>
                    ...
                    <tbody>";
                $c=0;
                while(list($_id,$_nm,$_act,$ord) = $this->db->sql_fetchrow($res))
                {
