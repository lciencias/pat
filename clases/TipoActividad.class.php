<?php
class TipoActividad  extends Comunes implements InterfazCatalogos{
    var $ddb;
    var $data;
    var $path;
    var $session;
    ...
    function __construct($db,$data,$session,$path,$pages){
        ...
        $this->pages  = $pages;
        $this->tabla  = "cat_tipo_actividad";
        $this->campo  = "actividad_id";
        $this->nmBoton="guardarTipoActividad";
    ...
    function regresaDescripcion(){
    	...
    	if($this->data['idTipoActividad'] > 0){
    		$buffer=$this->regresaDescripcionTipoActividad();
    	}
    	return $buffer;
    }
    ...
    function formato(){
        $buffer="
            ...
            <input type='hidden' name='valueId' id='valueId' value='".($this->array_datos[$this->campo] + 0)."'>
            <table width='80%' align='center' border='0'>
            <tr>
            <td>".BTNNUEVOTIPOACTIVIDAD."</td>
            <td><input type='text'  class='form-control validatexto' style='height: 30px;width:300px;'  value='".$this->array_datos['nombre']."' placeholder='".NMACTIVIDAD."' maxlength='200' name='nomCatalogo' id='nomCatalogo'>
    ...
    function listado(){
        ...
        <table width='95%' ><tr><td class='tdright'><button class='btn btn-success' name='buttonBuscar' id='buttonBuscar' type='button' value='1' onclick=\"location='aplicacion.php?aplicacion=".$this->session['aplicacion']."&apli_com=".$this->session['apli_com']."&opc=1'\">".BTNNUEVOTIPOACTIVIDAD."</button></td></tr></table>";
            ...
            {                
                    ...
                    <thead>
                        <tr class='alturaTableHeader'>
                            ...
                            <td width='15%' class='tdcenter cabecerasTable'>".TIPOACT."</td>
                            <td width='43%' class='tdcenter cabecerasTable'>".DESCRIPCION."</td>
                    ...
                    <tbody>";
                $c=0;
                while(list($_id,$_nm,$_des,$_act) = $this->db->sql_fetchrow($res))
                {
