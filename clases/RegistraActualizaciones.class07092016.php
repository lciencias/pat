					...
					<div class="tab-pane active" id="tabProyecto">
						...
						<table class="table table-condensed">
							...
							<tr class="altotitulo">
                				...
                				&nbsp;&nbsp;
								<button class="btn btn-warning actualizarBasetAct" name="actualizaBasePrimaria" id="actualizaBasePrimaria">'.ACTUALIZARBASE.'</button>
                				</td>
                			</tr>
						</table>
					</div>
				...
				<div id="collapse'.$tmpData['actividadId'].'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading'.$tmpData['actividadId'].'">
					<div class="panel-body">
						...
						<tr>
							...
							<br><br><br>
							<button class="btn btn-warning actualizarBasetAct" name="ab-'.$tmpData['actividadId'].'" id="ab-'.$tmpData['actividadId'].'">'.ACTUALIZARBASE.'</button>									
							</td>
                       </tr> 
                   </table>
			</div>
