...
class CrearTablas  extends ComunesEstadisticas implements InterfazCatalogos{
    ...
    function eliminar(){
        ...
        if( ($this->data['id']+0) > 0)
        {
        	$tablaC = strtolower(str_replace("View_","iew_C_",$this->tabla));
        	$tablaA = strtolower(str_replace("View_","View_A_",$this->tabla));
            ...
            $del    = "DROP TABLE IF EXISTS ".$this->tabla.";";
    ...
    function generaTabla(){
    	...
    	$sql= "CREATE TABLE ".$this->data['tabla']." as 
    			...
    			a.active as activoP, b.active as activoA
