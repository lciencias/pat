...
class UnidadPrograma  extends Comunes implements InterfazCatalogos{
    ...
    function listado(){
        ...
        if($no_registros > 0)
        {
            ...
            $sql="SELECT DISTINCT(a.".$this->campo."),a.nombre,a.active,a.orden,a.politica_id FROM ".$this->tabla."  as a
                ...
                $buffer.="
                    ...
                    <thead>
                        <tr class='alturaTableHeader'>
                            ...
                            <td width='24%' class='tdcenter cabecerasTable'>".PROGRAMA."</td>
                            <td width='24%' class='tdcenter cabecerasTable'>".POLITICAPUBLICA."</td>
                            <td width='24%' class='tdcenter cabecerasTable'>".AREA."</td>
                    ...
                    <tbody>";
                $c=0;
                while(list($_id,$_nm,$_act,$ord,$_pol) = $this->db->sql_fetchrow($res))
                {
