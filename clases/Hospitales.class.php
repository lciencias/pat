<?php
class Hospitales  extends Comunes implements  InterfazCatalogos{
    var $ddb;
    var $data;
    var $path;
    var $session;
    ...
    function __construct($db,$data,$session,$path,$pages){
        ...
        $this->pages  = $pages;
        $this->tabla  = "cat_hospitales";
        $this->campo  = "hospital_id";
        $this->nmBoton="guardarHospital";
    ...
    function formato(){
        $buffer="
            ...
            <input type='hidden' name='valueId' id='valueId' value='".($this->array_datos['hospital_id'] + 0)."'>
            <table width='80%' align='center' border='0'>
            <tr>
            <td>".BTNNUEVOHOSPITAL."</td>
            <td><input type='text' required='yes' class='form-control validatexto' style='height: 30px;width:300px;'  value='".$this->array_datos['nombre']."' placeholder='".NMHOSPITAL."' maxlength='200' name='nomCatalogo' id='nomCatalogo'>
    ...
    function generaFiltros(){
        $bufferFiltros="
            <table width='80%' align='center' border='0'>
              ...
              <tr><td class='tdcenter'><input type='text' class='form-control' style='height: 30px;' name='busqNombre' id='busqNombre' placeholder='".NMHOSPITAL."' value='".$this->data['busqNombre']."'></td></tr>
    ...
    function listado(){
        ...
        <table width='95%' ><tr><td class='tdright'><button class='btn btn-mio' name='buttonBuscar' id='buttonBuscar' type='button' value='1' onclick=\"location='aplicacion.php?aplicacion=".$this->session['aplicacion']."&apli_com=".$this->session['apli_com']."&opc=1'\">".BTNNUEVOHOSPITAL."</button></td></tr></table>";
            ...
            {                
                    ...
                    <thead>
                        <tr class='alturaTableHeader'>
                            ...
                            <td width='58%' class='tdcenter cabecerasTable'>".HOSPITAL."</td>
