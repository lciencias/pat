...
class Comunes {
    ...
    function valorPonderacion($data) {
    	$combo = "<select name='ponderacion' id='ponderacion'  class='bootstrap-select' style='width:40px;'>";
...
// 		}
    ...
    function recuperaPermisos($area_id, $programa_id,$ano_id) {
        $array = array();
        $filtro = "";

        if ($ano_id > 0)
        	$filtro.= "AND ano_id = '" . $ano_id . "' ";  
        else
        	$filtro.= "AND ano_id ='" . $this->session['anocaptura'] . "' ";
